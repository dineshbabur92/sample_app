...
describe User do
  #pending "add some examples to (or delete) #{__FILE__}"
	...
	describe "when is name is too long" do
	...
	describe "when email is invalid" do
		it "should be invalid" do
			address= %w[ foobar@foo,com user_at_foo.org example.user@foo.foo@bar_baz.com foo@bar+baz.com]
	...
	describe "when password doesn't match with password confirmation" do
